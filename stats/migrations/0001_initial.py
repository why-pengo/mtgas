# Consolidated initial migration — schema v2
# Changes from original:
#   - phash field on Card (previously in 0002)
#   - DeckSnapshot no longer has a match OneToOneField
#   - Match has a snapshot ForeignKey(DeckSnapshot, null=True) for deduplication
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # DeckSnapshot created before Match (Match now has a FK to DeckSnapshot)
        migrations.CreateModel(
            name="DeckSnapshot",
            fields=[
                (
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["is_resolved"], name="unknown_car_is_reso_33a012_idx"),
        ),
        migrations.AddIndex(
            model_name="unknowncard",
            index=models.Index(
